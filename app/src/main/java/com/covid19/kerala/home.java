...
Button profile, settings, volunteer, alert, pmcare, goafund, hospital, contact, preventive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goafund.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(home.this)
                        .setTitle("Kerala State COVID-19 Relief Fund.")
                        .setMessage("You will be redirected to the official payment link of Kerala State COVID-19 Relief Fund. Do you want to continue?")
                        .setPositiveButton("Continue", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                // Continue with COVID-19 goa relief fund
                                Uri uriUrl = Uri.parse("https://donation.cmdrf.kerala.gov.in/");
                                Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                                startActivity(launchBrowser);
                            }
                        })
